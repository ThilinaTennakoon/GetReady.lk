...
class CollectionsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/Collections/All/Index', [
            'filters' => $filters,
            'collections' => CollectionResource::collection($this->collectionInterface->filter($filters)),
          //'collectionStatus' => $this->enumToSelect(CollectionStatusEnum::cases())
        ]);
    }
